...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> getNews({
    ...
    if (channel != null) {
      ...
      category = null;
      baseApi =
          'https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&sources=$channel&apiKey=855ae01438f1464b8748b9e95bfca965';
    }
    if (searchKey != null) {
      country = null;
      category = null;
